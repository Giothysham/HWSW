  ...
  # Project to test
  #
  # launch with: source /home/jvliegen/vc/github/KULeuven-Diepenbeek/course_hwswcodesign_internal/ch1/scripts/tcl/vivado_proj.tcl
  ################################################################################
  
  set pname "riscv_main_synth"
  set path D:/School/MA/HWSW/VHDL/test
  set srcpath D:/School/MA/HWSW/Source_code/HWSW/hwswcd_template
